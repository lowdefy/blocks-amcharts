...
import { ContextBlock } from '../src';
import examples from '../demo/examples/ContextBlock.yaml';
import meta from '../src/blocks/ContextBlock/ContextBlock.json';

runRenderTests({ examples, Block: ContextBlock, meta });
...
test('callAction onClick', () => {
  ...
  const Shell = () => <ContextBlock {...getProps(block)} methods={methods} />;
