...
// import { AmChartsXY } from '../src';
import examples from '../demo/examples/AmChartsXY.yaml';
import meta from '../src/blocks/AmChartsXY/AmChartsXY.json';
...
// runRenderTests({ examples, Block: AmChartsXY, meta });
